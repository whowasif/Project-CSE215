...
public class AddAdmin extends JFrame implements Serializable {
	...
	private void initialize() {
		...
		btnNewButton_1_2_1_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Admin Info Added." ,"Successfull" , JOptionPane.CLOSED_OPTION);
		...
		textField_4.setBounds(295, 230, 76, 19);
		...
		comboBox.setBounds(409, 231, 85, 21);
		panel.add(comboBox);
