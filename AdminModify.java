...
import Adminfaculty.SearchFaculty;
...
public class AdminModify extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminModify window = new AdminModify();
	...
	private void initialize() {
		...
		JButton btnNewButton_1 = new JButton("Add Admin");
		...
		JButton btnNewButton_1_1 = new JButton("Remove Admin");
		...
		JButton btnNewButton_1_2 = new JButton("Modify Admin");
		...
		JButton btnNewButton_1_3 = new JButton("Search Admin");
