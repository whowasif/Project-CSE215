...
public class FacultyModify extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FacultyModify window = new FacultyModify();
	...
	private void initialize() {
		...
		JButton btnNewButton_1_1 = new JButton("Modify Faculty");
		...
		JButton btnNewButton_1_2 = new JButton("Remove Faculty\r\n\r\n");
		btnNewButton_1_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frame.dispose();
				RemoveFaculty rf = new RemoveFaculty();
		...
		JButton btnNewButton_1_3 = new JButton("Search Faculty");
		btnNewButton_1_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frame.dispose();
				SearchFaculty sf = new SearchFaculty();
