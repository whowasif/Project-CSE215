...
public class RemoveCourse extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RemoveCourse window = new RemoveCourse();
	...
	private void initialize() {
					...
					sc = new Scanner(file);
					 while (sc.hasNext()) {
					        ...
					        if (line.contains(textField.getText())) {
					        	...
					        	found = true;
					        	textField_1.setText(course.getName());
					        	textField_2.setText(course.getCredit());
					        	textField_3.setText(course.getFaculty());
		...
		textField_1.setBounds(310, 87, 205, 25);
		panel.add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(310, 118, 205, 25);
		panel.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(310, 149, 205, 25);
		...
		btnNewButton_1.setBounds(467, 233, 136, 35);
