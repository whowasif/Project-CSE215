...
public class AdminHomePage extends JFrame {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Welcome to Admin Home Page !!");
		lblNewLabel.setBounds(325, 92, 451, 141);
		panel.add(lblNewLabel);
		lblNewLabel.setFont(new Font("Bahnschrift", Font.BOLD | Font.ITALIC, 20));
		
		JLabel lblEnjoyYourWork = new JLabel("Enjoy Your Work .");
		lblEnjoyYourWork.setFont(new Font("Bahnschrift", Font.ITALIC, 20));
		lblEnjoyYourWork.setBounds(368, 166, 451, 141);
		panel.add(lblEnjoyYourWork);
	}
}
